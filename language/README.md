...
Refer users to the labels on UI elements, not the type of element (such as menu or button) or it's location on the page.
...
Double angle brackets | &laquo;<br />&raquo; | `&laquo;`<br />`&raquo;` | `\u00AB`<br />`\u00BB`<br />`ALT+174`<br />`ALT+175` | Omit double angle brackets from links or buttons that open another page or step. | 
En dash | &ndash; | `&ndash;` | `\u2013`<br />`ALT+0150` | Use an en dash instead of a hyphen to indicate a range, without spaces. <br />Avoid using dashes to separate text. If you must, use dashes for this purpose – like this – use an en dash surrounded by spaces. | 3–5 kg
...
Primes | &prime;<br />&Prime; | `&prime;`<br />`&Prime;` | `\u2032`<br />`\u2033` | Use prime (&prime;) only in abbreviations for feet, arcminutes, and minutes. <br />Use double-prime (&Prime;) only in abbreviations for inches, arcminutes, and minutes. | 3° 15′<br />3° 15′ 35″
