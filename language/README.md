...
En dash | &ndash; | `&ndash;` | `\u2013`<br />`ALT+0151` | Use an en dash instead of a hyphen to indicate a range, without spaces. <br />Avoid using dashes to separate text. If you must, use dashes for this purpose – like this – use an en dash surrounded by spaces. | 3–5 kg
